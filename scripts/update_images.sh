...
docker tag airflow-worker:latest 1481767455/airflow-worker:latest
docker push 1481767455/airflow-worker:latest
docker tag airflow:latest 1481767455/airflow:latest
docker push 1481767455/airflow:latest
